...
class DynamicWidgetsApp(App):
    ...
    def __init__(self, **kwargs):
        ...
        self.name_to_phone = {"Bob Brown": "0414144411", "Cat Cyan": "0441411211",
                              "Oren Ochre": "0432123456", "Indiana Jones": "911911911"}
    ...
    def add_contact(self):
        ...
        # Take information from the boxes
        name = self.root.ids.input_name.text.strip()
        contact_number = self.root.ids.input_contact_number.text.strip()

        # Add to dictionary
        self.name_to_phone[name] = contact_number

        self.status_text = f"{name} added!"
        self.clear_all()   # to clear all widgets
        self.create_widgets()   # rebuild the buttons again
        pass
